...
void test_table_open_close() {
  ...
  assert(table != NULL);
  assert(block_storage_get_page_count(table->block_storage) == 0);
  ...
  assert(table != NULL);
  assert(block_storage_get_page_count(table->block_storage) == 3);
  db_close_table(table);
...
void test_table_insert_row() {
  ...
  assert(block_storage_get_page_count(table->block_storage) == 2);
